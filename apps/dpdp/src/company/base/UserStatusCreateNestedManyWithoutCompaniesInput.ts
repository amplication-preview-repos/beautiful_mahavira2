...
@InputType()
class UserStatusCreateNestedManyWithoutCompaniesInput {
...
export { UserStatusCreateNestedManyWithoutCompaniesInput as UserStatusCreateNestedManyWithoutCompaniesInput };
