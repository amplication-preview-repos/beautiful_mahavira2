...
@InputType()
class FieldModelCreateNestedManyWithoutCompaniesInput {
...
export { FieldModelCreateNestedManyWithoutCompaniesInput as FieldModelCreateNestedManyWithoutCompaniesInput };
